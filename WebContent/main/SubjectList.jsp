			...
			<table border="1">
				...
				<tbody>
					<c:forEach var="subject" items="${requestScope.subjectList}">
						<tr>
							<td><center>
									<input type="checkbox" name="code" value=${subject.sub_code} >
								</center></td>
							...
							<td>${subject.time2}</td>
							<td><center>
									<input type='button' value='개별신청'
										onclick='location.href="singleapply?code=${subject.sub_code}";'>
								</center></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
			<input type="submit" value="다중신청하기"> <br> <br> <b>저장하고
				종료 : <input type='button' value='저장' onclick='location.href="save";'>
			</b>
		</form>
	</div>
</body>
